...
**Justificació:**  
SiteGround ofereix el millor rendiment per a webs amb imatges pesades gràcies al seu CDN integrat, servidors SSD ràpids i eines d’optimització. És ideal per a un portfoli fotogràfic. El domini `.photo` reforça la identitat visual i professional del projecte.
...
1. Facilitar streaming i transmissió en directe integrant Twitch / YouTube.  
2. Mostrar calendari d’esdeveniments / tornejos amb pics de trànsit.  
3. Actualitzar notícies relacionades amb els eSports.  
4. Tenir una base estable per creixement de visites, amb mínima latència i bon rendiment.  
5. Protegir la marca amb domini competitiu (“gamer”) i extensió adequada, correus corporatius, SSL, etc.  
